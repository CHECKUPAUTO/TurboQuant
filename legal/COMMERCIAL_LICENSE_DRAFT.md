# TurboQuant — Commercial License Agreement (Draft Template)
...
**Covered Software:** **TurboQuant** — a CCOS module (the TQ3 tile codec and
the CCOS Soft-Paging correction rung), as maintained in the repository
<https://github.com/CHECKUPAUTO/TurboQuant>, including its Python and Rust
components and the versions specified in the applicable Order Form. The
companion CCOS tile kernel **SLHAv2** is covered by the parallel draft in its
own repository (`SLHAv2/legal/COMMERCIAL_LICENSE_DRAFT.md`); [a single Order
Form may reference both agreements for a combined CCOS deployment].
---
